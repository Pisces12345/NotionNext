...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '昕昕丶未来不是梦', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的前端工程狮🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pisce.buzz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '前端, 博客', // 网站关键词 英文逗号隔开
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个前端工程狮, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
