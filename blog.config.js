...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个大学牲', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://pisce.buzz/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '纯ocd, enfj, 计算机，cocos游戏开发，数学老师', // 网站关键词 英文逗号隔开
